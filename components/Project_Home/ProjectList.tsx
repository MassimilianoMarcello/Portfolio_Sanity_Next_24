            ...
            {groupedProjects[cat.value].map((project, idx,arr) => {
              ...
              return (
                ...
                <article key={project._id} className={styles.projectCard}>
                  ...
                  {/* ── ROW 2: Title — full width, centrato + status pill ── */}
                  ...
                  {/* ── ROW 3: Content row — immagine SX + problem/solution DX ── */}
                  <div className={styles.contentRow}>
                    ...
                    {/* Right: problem + solution (solo questi due, impact è sotto) */}
                  ...
                  {/* ── ROW 4: Impact — full width, bg azzurro ── */}
                  {project.impact && (
